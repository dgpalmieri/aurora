...
#include <fstream> /* I think for C++ what we need is fstream out of stdio.h; substituting */
#include <stdlib.h>
#include <math.h>
#include <unistd.h>
...
const double TO_SHORT = 10000.0;
const double FROM_SHORT = 0.0001;
static const double DEG2RAD = (M_PI/180.0);
const int BYTE2ENERGY = 31;
const int MIN_ENERGY = 3000;
...
/* if this is a constant, it should be declared with const? */
/* double maxtexture = 211.0; */
/* or maybe it isn't a constant? */
const double maxtexture = 211.0;
...
const int MIN_RED_ENERGY = 500;

/* set in render.cpp (this file) but used elsewhere? */
