...
/* Green Channel */
static int   g_ctl_pts = 5;
static int   g_frame_num[MAX_POINTS] = {  0,   100,  800,  960, 1023};
static float g_red[MAX_POINTS]       = {0.0, 0.058, 0.26, 0.29, 0.29};
static float g_green[MAX_POINTS]     = {0.0, 0.184, 0.83, 0.92, 0.92};
static float g_blue[MAX_POINTS]      = {0.0, 0.122, 0.55, 0.61, 0.61};
...
/* Red Channel */
static int   r_ctl_pts = 5;
static int   r_frame_num[MAX_POINTS] = {  0,   100,   800,  960, 1023};
static float r_red[MAX_POINTS]       = {0.0, 0.184, 0.828, 0.92, 0.92};
static float r_green[MAX_POINTS]     = {0.0, 0.036, 0.162, 0.18, 0.18};
static float r_blue[MAX_POINTS]      = {0.0, 0.016, 0.070, 0.08, 0.08};
